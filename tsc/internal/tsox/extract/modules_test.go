...
func TestModuleFencesNameUnsupportedFormsAndOriginalSource(t *testing.T) {
	cases := []struct{ name, source, construct string }{
		...
		{"namespace export", `export * as ns from "./dep.ts";`, "ModuleExport"},
		{"export string name", `export { value as "name" } from "./dep.ts";`, "ModuleExport"},
		{"export string source", `export { "value" as name } from "./dep.ts";`, "ModuleExport"},
		{"export default source", `export { default as name } from "./dep.ts";`, "ModuleExport"},
		{"export default alias", `export { value as default } from "./dep.ts";`, "ModuleExport"},
		{"export attributes", `export { value } from "./dep.ts" with { type: "json" };`, "ModuleExport"},
		{"export package", `export { value } from "a-package";`, "ModuleSpecifier"},
		{"export extensionless", `export {} from "./dep";`, "ModuleSpecifier"},
		{"export URL encoding", `export {} from "./%64ep.ts";`, "ModuleSpecifier"},
		{"export declaration source", `export type { Item } from "./dep.d.ts";`, "ModuleSpecifier"},
